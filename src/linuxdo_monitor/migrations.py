...
MIGRATIONS = {
    ...
    5: [
        # 创建 categories 表
        "CREATE TABLE IF NOT EXISTS categories (id INTEGER NOT NULL, forum TEXT NOT NULL DEFAULT 'linux-do', name TEXT NOT NULL, slug TEXT, description TEXT, PRIMARY KEY (id, forum))",
        "CREATE INDEX IF NOT EXISTS idx_categories_forum ON categories(forum)",

        # 初始化 linux-do 分类数据
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (4, 'linux-do', '开发调优', 'develop')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (11, 'linux-do', '搞七捻三', 'gossip')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (14, 'linux-do', '资源荟萃', 'resource')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (27, 'linux-do', '非我莫属', 'job')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (32, 'linux-do', '读书成诗', 'reading')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (34, 'linux-do', '前沿快讯', 'news')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (36, 'linux-do', '福利羊毛', 'welfare')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (42, 'linux-do', '文档共建', 'wiki')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (46, 'linux-do', '扬帆起航', 'startup')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (92, 'linux-do', '网络记忆', 'feeds')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (98, 'linux-do', '国产替代', 'domestic')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (102, 'linux-do', '社区孵化', 'incubator')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (106, 'linux-do', '积分乐园', 'credit')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (110, 'linux-do', '虫洞广场', 'square')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (2, 'linux-do', '运营反馈', 'feedback')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (45, 'linux-do', '深海幽域', 'muted')",
        "INSERT OR IGNORE INTO categories (id, forum, name, slug) VALUES (35, 'linux-do', '纯水', 'pure-water')",
